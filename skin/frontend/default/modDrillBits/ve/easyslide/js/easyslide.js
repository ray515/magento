...
Object.extend(Object.extend(Glider.prototype, Abstract.prototype), {
    ...
    addObservers: function(){
        ...
        //Arrows
        var stop = this.wrapper.getElementsBySelector('div.easyslidercontrol a.easyslide-stop');
        stop.invoke('observe', 'click', this.stop.bind(this));
        
        var play = this.wrapper.getElementsBySelector('div.easyslidercontrol a.easyslide-play');
        play.invoke('observe', 'click', this.start.bind(this));
        
        var prev = this.wrapper.getElementsBySelector('a.easyslide-prev');
        prev.invoke('observe', 'click', this.previous.bind(this));

        var next = this.wrapper.getElementsBySelector('a.easyslide-next');
